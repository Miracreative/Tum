		...
		<ImageBackground
			...
			<View style={{flex: 0.8}}>
				...
				<View style={{flex: 0.2, marginBottom: 20}}>
					<BtnButton onPress={() => {navigation.navigate('Account')}} title={t('getStarted')} buttonStyle={{marginTop: 15, backgroundColor:"#F55926"}} textStyle={{color: 'rgba(244, 237, 225, 1)'}} arrow={true} />
